...
module.exports = {
    ...
    create,
    update,
    updateStatus,           // New function for updating just the status
    getAllByStatus          // New function to filter accounts by status
};
...
// New function to get accounts by status
async function getAllByStatus(status) {
    if (status !== 'active' && status !== 'inactive') {
        throw 'Invalid status. Status must be either "active" or "inactive"';
    }
...
// New function to update just the status of an account
